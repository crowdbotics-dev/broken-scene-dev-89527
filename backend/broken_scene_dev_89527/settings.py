"""
Django settings for broken_scene_dev_89527 project.
...
ROOT_URLCONF = 'broken_scene_dev_89527.urls'
...
WSGI_APPLICATION = 'broken_scene_dev_89527.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_scene_dev_89527 API",
    "DESCRIPTION": "API documentation for broken_scene_dev_89527 App",
    "VERSION": "v1",
}
